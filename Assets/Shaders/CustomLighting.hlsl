...
// CustomLighting reference code by NedMakesGames
// Video Reference: https://www.youtube.com/watch?v=GQyCPaThQnA
// Article Reference: https://nedmakesgames.medium.com/creating-custom-lighting-in-unitys-shader-graph-with-universal-render-pipeline-5ad442c27276
...
float3 CustomLightHandling(CustomLightingData d, Light light) {
    ...
    // Light Attenuation (Change this value as sun scales, not the light)
    // Or you could make the light be at the smallest possible value and max distanceAttenuation
